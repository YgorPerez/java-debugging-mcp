# 0023 — The heap query ships, and it reports the pause it imposed rather than refusing
...
- The handles are `@0x…` and therefore weak (ADR-0022). A listing is a snapshot of the heap at one
