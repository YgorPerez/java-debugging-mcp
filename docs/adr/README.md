...
| [0021](0021-an-object-handle-is-printed-weak-and-never-pinned.md) | An object handle is the `@0x…` every reply prints, and it stays a weak reference — nothing is pinned |
| [0022](0022-a-heap-query-ships-and-reports-the-pause-it-imposed.md) | The heap query ships and reports the pause it imposed, rather than refusing or asking permission |
