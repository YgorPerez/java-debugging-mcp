...
| [0019](0019-a-conditional-stop-point-decides-on-one-thread-and-escalates.md) | A conditional stop point decides on one thread, and escalates to a VM-wide suspend only when the condition holds |
