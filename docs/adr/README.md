...
| [0019](0021-an-object-handle-is-printed-weak-and-never-pinned.md) | An object handle is the `@0x…` every reply prints, and it stays a weak reference — nothing is pinned |
