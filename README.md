...
- **Thread dumps with lock ownership**: `debug.thread_dump` answers "it's wedged — which threads are
  ...
  listed, because that is creation order and an app server creates its request pool last (ADR-0012)
